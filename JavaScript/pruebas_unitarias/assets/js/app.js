...
/* console.assert(
    suma(1,3) === 4,
    'el resultado de la suma de 1 y 3 deveria ser 4'
);

console.assert(suma(1,3) === 4, 'el resultado de la suma de 1 y 3 deveria ser 4'
); */
...
arr.forEach(prueba => {
    ...
    `Suma de ${a} y ${b} deveria ser ${resultado}`);
});
